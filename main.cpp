...
Fantasma fantasma1(210, 171, 1);
Fantasma fantasma2(186, 219, 1);
Fantasma fantasma3(210, 219, 0);
Fantasma fantasma4(234, 219, 3);

Pacman pacman(210, 267, 50);
...
void initMatAdy()
{
    ...
    matAdy[5][0] = -1; matAdy[5][1] = -1; matAdy[5][2] = -1; matAdy[5][3] = 80; matAdy[5][4] = -1; matAdy[5][5] = 99; matAdy[5][6] = -1; matAdy[5][7] = 60; matAdy[5][8] = -1; matAdy[5][9] = -1; matAdy[5][10] = -1;
    ...
    X[10] = 0.0; X[42] = 1.0; X[90] = 2.0; X[138] = 3.0; X[186] = 4.0; X[210] = 5.0; X[234] = 6.0; X[282] = 7.0; X[330] = 8.0; X[378] = 9.0; X[410] = 10.0;
    Y[11] = 0.0; Y[75] = 1.0; Y[123] = 2.0; Y[171] = 3.0; Y[219] = 4.0; Y[267] = 5.0; Y[315] = 6.0; Y[363] = 7.0; Y[411] = 8.0; Y[459] = 9.0;
}
...
void dibujaLaberinto() {
    ...
    glVertex2f(169, 201);   glVertex2f(206, 201); //Obstaculo 10
    ...
    glVertex2f(124, 249);   glVertex2f(131, 249); //Obstaculo 11
    ...
    glVertex2f(172, 297);   glVertex2f(275, 297); //Obstaculo 12
    ...
    glVertex2f(316, 249);   glVertex2f(323, 249); //Obstaculo 13
    ...
    glVertex2f(44, 345);    glVertex2f(83, 345); //Obstaculo 14
    ...
    glVertex2f(124, 345);   glVertex2f(179, 345); //Obstaculo 15
    ...
    glVertex2f(268, 345);   glVertex2f(323, 345); //Obstaculo 16
    ...
    glVertex2f(364, 345);   glVertex2f(403, 345); //Obstaculo 17
    ...
    glVertex2f(44, 441);    glVertex2f(117, 441); //Obstaculo 18
    ...
    glVertex2f(172, 393);   glVertex2f(275, 393); //Obstaculo 19
    ...
    glVertex2f(268, 441);   glVertex2f(309, 441); //Obstaculo 20
...
void display() {
    ...
    glPushMatrix();
    fantasma1.cargarMatriz(matAdy, X, Y);
    fantasma1.update();
    fantasma1.draw(texture[4]);
    glPopMatrix();

    glPushMatrix();
    fantasma2.cargarMatriz(matAdy, X, Y);
    fantasma2.update();
    fantasma2.draw(texture[5]);
    glPopMatrix();

    glPushMatrix();
    fantasma3.cargarMatriz(matAdy, X, Y);
    fantasma3.update();
    fantasma3.draw(texture[6]);
    glPopMatrix();

    glPushMatrix();
    fantasma4.cargarMatriz(matAdy, X, Y);
    fantasma4.update();
    fantasma4.draw(texture[7]);
    glPopMatrix();

    glPushMatrix();
    pacman.cargarMatriz(matAdy, X, Y);
    pacman.update();
...
void loadTextureFromFile(char *filename, int siguiente)
{
    ...
    glGenTextures(1, &texture[siguiente]);
    //bind to the new texture ID
    glBindTexture(GL_TEXTURE_2D, texture[siguiente]);
...
char* filename0 = "PacmanArriba.bmp";
char* filename1 = "PacmanDerecha.bmp";
char* filename2 = "PacmanAbajo.bmp";
char* filename3 = "PacmanIzquierda.bmp";

char* filename4 = "fantasmaRojo.bmp";
char* filename5 = "fantasmaNaranja.bmp";
char* filename6 = "fantasmaAzul.bmp";
char* filename7 = "fantasmaRosa.bmp";
